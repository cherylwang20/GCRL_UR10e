...
class CustomDictFeaturesExtractor(BaseFeaturesExtractor):
    def __init__(self, observation_space, features_dim=1024):  # Adjust features_dim if needed
        ...
        self._features_dim = observation_space.spaces['image'].shape[0]* observation_space.spaces['image'].shape[1]+ 1024 # Adjust based on actual output dimensions of cnn and mlp

...
def main():
    ...
    ENTROPY = config_sweep.entropy
    LR = linear_schedule(config_sweep.learning_rate)
    CR = linear_schedule(config_sweep.clip_range)
    ...
    try:
        ...
        config = {
            ...
            "seed": args.seed,
            "entropy": ENTROPY,
            "lr": config_sweep.learning_rate,
            "CR": config_sweep.clip_range,

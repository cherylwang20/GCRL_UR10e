...
class BasicReachGrasp(gym.Env):
    ...
    def __init__(self, render_mode=None):
        ...
        self.observation_space = gym.spaces.Dict({
            'image': gym.spaces.Box(low=0, high=255, shape=(self.nwidth, self.nheight, 1), dtype=np.float64),  # Use np.float32 here
    ...
    def forward(self):
        ...
        #print(image.size)
        obs = {'image': self.current_image.reshape((self.nwidth, self.nheight, 1)), 'vector': obsvec}
    ...
    def reset(self, seed=None):
        ...
        target_names = ['red cube', 'green apple', 'yellow rubber duck'] #'toy rubber duck', 'plastic cylinder', 
        ...
        self.final_image = np.ones((self.nwidth, self.nheight, 1), dtype=np.uint8)
        self.step_count = 0
        self.done = False
